...
import 'package:ydrs_desktop_app/blocs/pin_validation/pin_screen_validate_bloc.dart';
...
import 'package:ydrs_desktop_app/network/services/login/pin_validate_api.dart';
...
class PinPutViewState extends State<PinPutView> {
  ...
  //     var source = "Verify Pin";
  //     var message = "An Exception occurred in while checking biometric";
  ...
  Future<void> _getListOfBiometricTypes() async {
    try {
      ...
      var source = "Verify Pin";
      var message = "An Exception occurred in getting list of biometric";
      // _logException.logExceptionApi(e, message, source);
    }
    if (!mounted) return;
  }
  ...
  //   } on PlatformException catch (e) {
  //     var source = "Verify Pin";
  //     var message = "An Exception occurred in getting authentic user";
  //     _logException.logExceptionApi(e, message, source);
  //   }
  //   if (!mounted) return;
