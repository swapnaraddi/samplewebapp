...
class AppStrings {
  ...
  static const pinDoNotMatch = "Pin doesn't match ";
  ...
  static const selectedPatient = 'Patient Name';

  //searchable dropdowns
  static const dictationstxt = 'Dictations';
  static const dictationtxt = 'Dictation Status ';
  static const manualDictationTxt = 'Dictation';
  ...
  //team 3
  static const saveToDB = "Uploading";
  ...
  static const imageDateFormat = "yyyyMMddmmssms";
  ...
  //demorgraphic page strings
  static const cases = "Case";
  static const contact = "Contact";
  static const phone = "Phone";
  static const email = "Email";
  static const address = "Address";
  static const casesList = "Cases";
  static const doA = "DOA";
  static const casesDetail = "Case Details";
  static const state = "State";
  static const attorney = "Attorney";
  static const insurance = "Insurance";
  static const claimNum = "Claim No";
  static const carrier = "Carrier";
  static const plan = "Plan";
  static const appointments = "Appointments";
  static const assements = "Assements";
  static const document = "Documents";
  static const referrals = "Referrals";
  static const care = "Care Team";
  static const toastMsg = "No Patients Found";
  static const appointment = "Appointment";
  static const upcoming = "Upcoming";
  static const past = "Past";
  static const noupcomingappointments = 'No Upcoming Appointments';
  static const nopastappointments = 'No Past Appointments';
  static const caseData = "caseDatas";
  static const countData = "countData";
  static const doaDate = "doa";
  static const documentData = "documentList";
  static const episodeId = "id";
  static const patientDetail = "patientDetails";
  static const casesCount = "cases";
  static const nofilesFound = "No Files Found";
  static const reasonForAccess = "Reason for Request Access";
  static const reason = "Reason";
  static const requestAccess = 'Request Access';
  static const age = "Age";
  static const upComingData = "upcomingDataList";
  static const pastData = "pastDataList";

  static const accessReasonRequired = 'Please enter reason';

  //Database table
  static const databaseName = 'ydrslocaldb';
  static const dbTableDictation = "dictation";
  static const dbTableExternalAttachment = 'externalattachment';
  static const dbTablePhotoList = 'photolist';
  static const dbTablePhotoListExternal = 'externalphotolist';
  static const dbexternalDocumentType = 'documenttypes';
  static const dbLocation = 'locations';
  static const dbProvider = 'providers';
  static const dbPractice = 'practices';
  static const dbcaseTypeDropdown = 'casetypes';
  static const dbcaseTypeState = 'casetypestates';
  static const dbAppointmentType = 'appointmenttypes';
  static const dbTimeSlots = 'timeslots';
  ...
  static const networkNotConnected = 'Please check the internet connection';
  ...
  static const deleteOlderRecords =
      "DELETE FROM dictation WHERE createdDate <= date('now','-90 day') AND uploadedtoserver = 1";
  static const deleteOlderImageRecords =
      "DELETE FROM photolist WHERE createdDate <= date('now','-90 day') AND uploadedtoserver = 1";
  static const deleteAllExternalRecords =
      "DELETE FROM externalattachment WHERE createdDate <= date('now','-90 day')";
  static const selectAllDictationsQuery = "SELECT * FROM dictation";

  static const syncRecordsToServer =
      'SELECT * FROM dictation WHERE uploadedtoserver = 0';
  static const updateOfflineRecords = ''' UPDATE dictation
    SET uploadedtoserver = ?, dictationid = ? 
    WHERE id = ?
    ''';
  static const updateOfflinePhotoListRecords =
      ''' UPDATE photolist  SET uploadedtoserver = ?
     WHERE dictationlocalid = ?
    ''';
  static const updateOfflineExternalRecords = '''UPDATE externalattachment
    SET uploadedtoserver = ?, externalattachmentid = ? 
    WHERE id = ?
    ''';

  static const updateOfflineManualPhotoListRecords = ''' UPDATE dictation
    SET uploadedtoserver = ?, dictationid = ? 
    WHERE id = ?
    ''';

  static const selectexternalattachmnentQuery =
      'SELECT * FROM externalattachment WHERE uploadedtoserver = 0';
  static const selectPhotoQuery =
      'SELECT physicalfilename FROM photolist WHEREid=id';

  static const selectManualDictationQuery =
      'SELECT * FROM dictation WHERE dos NOT NULL AND uploadedtoserver = 0';

  // static const selectManualDictationQuery =
  //     'SELECT * FROM dictationlocal WHERE uploadedtoserver = 0';
  static const selectManualDictationPhotoListQuery =
      'SELECT physicalfilename FROM photolist WHEREid=id';
  static const selectIdFromTable = 'SELECT id FROM dictation';

  static const selectImagesForAutoSyncForManualDictation =
      "SELECT * FROM photolist WHERE dictationlocalid=id";

  ///delete Manual & external screen time slots  table
  static const deleteTimeSlotsTbl = 'DELETE FROM timeslots';

  ///delete external & manual screen appointment type table
  static const deleteAppointmentTypesTbl = 'DELETE FROM appointmenttypes';

  static const deleteLocationsTbl = 'DELETE FROM locations';

  //Table for Patient Dictation and Manual Dictation
  static const tableDictation = 'CREATE TABLE IF NOT EXISTS dictation('
  ...
  static const tableExternalAttachment =
      'CREATE TABLE IF NOT EXISTS externalattachment ('
  ...
  static const tblPhotoListExt =
      'CREATE TABLE IF NOT EXISTS externalphotolist ('
      'id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL ,'
  ...
  static const tblPhotoList = 'CREATE TABLE IF NOT EXISTS photolist ('
      'id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL ,'
      'dictationlocalid INTEGER DEFAULT NULL,'
      'externalattachmentlocalid INTEGER DEFAULT NULL,'
      'attachmentname TEXT DEFAULT NULL,'
  ...
  //Manual Appointment type table
  static const AppointmentType = 'CREATE TABLE IF NOT EXISTS appointmenttypes ('
      'id INTEGER,'
      'name TEXT DEFAULT NULL'
      ')';

  //Manual Appointment type table
  static const tblQuickTimeSlots = 'CREATE TABLE IF NOT EXISTS timeslots ('
      'id INTEGER,'
      'standardTime TEXT DEFAULT NULL'
      ')';
  static const caseTypeDropdown = 'CREATE TABLE IF NOT EXISTS casetypes ('
      'id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,'
      'name TEXT DEFAULT NULL'
      ')';

  static const caseTypeStateDropdown =
      'CREATE TABLE IF NOT EXISTS casetypestates ('
      'id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,'
      'name TEXT DEFAULT NULL'
      ')';

  //Homescreen location drop down
  static const locations = 'CREATE TABLE IF NOT EXISTS locations ('
      'locationId INTEGER DEFAULT NULL,'
      'locationName TEXT DEFAULT NULL'
      ')';

//Home screen provider drop down
  static const providers = 'CREATE TABLE IF NOT EXISTS providers ('
      'providerId INTEGER DEFAULT NULL,'
      'displayname TEXT DEFAULT NULL'
      ')';

//manual screen practice drop down
  static const practices = 'CREATE TABLE IF NOT EXISTS practices ('
  ...
  static const interruptionErrorMsg =
      "Dictation was paused due to interruption, Please click on Record button to continue or click on submit button to upload or click on Cancel (Dictation will be lost)";
  static const manualDicInterruptionErrorMsg =
      "Dictation was paused due to interruption, Please click on Resume to continue or click on save recording to upload or click on Cancel (Dictation will be lost)";
  ...
  static var syncingOffline = "Syncing Data...";
}
...
//get case details
  static const getCaseDetails =
      AppConstants.dioBaseUrl + "api/Patient/GetCaseDetailsList";
//get doc folder
  static const getDocumentFolder = AppConstants.dioBaseUrl +
      "api/Patient/GetEpisodeDocumentFoldersForMember";
  //get documents
  static const getDocuments =
      AppConstants.dioBaseUrl + "api/Patient/GetEpisodeFolderDocumentsList";
  //get appointment count
  static const getAppointmentCount =
      AppConstants.dioBaseUrl + "api/Patient/AppointmentDetailsList";
//get searched patient
  static const getSearchPatients =
      AppConstants.dioBaseUrl + "api/Patient/GetSearchPatients";
//get patient deatils
  static const getPatientDetailsList =
      AppConstants.dioBaseUrl + "api/Patient/GetPatientDetailsList";

  static const getEpisodeAppointment =
      AppConstants.dioBaseUrl + "api/Patient/EpisodeAppointmentDetailsList";
}
